/**
 * SEP-24 anchor callback verification and state application, JWT flavour.
 *
 * Serves `POST /api/sep24/callback`. The HMAC-authenticated sibling for this
 * same event stream lives in src/services/sep24.ts and serves
